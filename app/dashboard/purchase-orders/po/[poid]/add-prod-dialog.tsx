...
interface AddProductDialogProps {
  ...
  onAdd: (product: Omit<Product, "id" | "businessProductId">) => void;
}
...
export function AddProductDialog({
  ...
  const form = useForm<AddProductFormData>({
    ...
    defaultValues: {
      businessProductId: "",
      productBarcode: "", // Will map to barcode
      productName: "", // Will map to name
      price: 0,
      quantity: 1,
      total: 0,
    },
  ...
  const onSubmit = (values: AddProductFormData) => {
    const product: Omit<Product, "id" | "businessProductId"> = {
