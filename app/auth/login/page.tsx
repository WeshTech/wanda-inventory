                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                className="pr-12 h-11 border-border focus:border-primary focus:ring-primary"
                                disabled={isLoading}
                                {...field}
                              />
                              <Button
                              ...
                              >
                                {showPassword ? (
                                  <EyeOff className="h-4 w-4 text-muted-foreground transition-transform duration-200 group-hover:scale-125" />
                                ) : (
                                  <Eye className="h-4 w-4 text-muted-foreground transition-transform duration-200 group-hover:scale-125" />
                                )}
                              </Button>
                            </div>
                          </FormControl>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            placeholder="000000"
                            maxLength={6}
                            className="h-12 text-center text-xl tracking-widest font-mono border-border"
                            disabled={isLoading}
                            {...field}
                            value={field.value || ""}
                          />
